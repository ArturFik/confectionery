  ...
  return (
    <div className=" bg-white h-auto">
      <div className="pt-[20px] pb-[20px] max-w-[1234px] mx-auto px-[5%]">
        <div className="flex flex-col custom:flex-row items-center">
          <h1 className="font-[FontsDrops] text-[96px]">Menu</h1>
          <div
            className="border-[2px] w-full custom:w-[40%] border-[#d29099] flex flex-row items-center gap-3
          rounded-[35px] py-[10px] px-2 mx-auto"
          >
            <img
              src="/search.png"
              alt=""
        ...
        <div className="flex flex-col items-start custom:flex-row mt-4">
          ...
          <div className="w-[75%] relative mx-auto grid grid-cols-1 sm:grid-cols-2 custom:grid-cols-3 gap-5">
            {sliderData.map((item, i) => (
              <div className="w-full bg-[#ffc6c6] rounded-[45px] border-[1px] border-[#F59696] max-w-[250px] mx-auto flex flex-col h-full">
                <img
                  src={item.image}
                  alt={item.image}
                ...
                <div className="mb-4 flex flex-row justify-between px-2">
                  <button
                    className="w-[48%] py-[10px] rounded-full bg-[red] text-white transition-transform 
                      duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-[white]"
                  >
                    Купить
                  </button>
                  <button
                    className="w-[48%] py-[10px] rounded-full bg-white transition-transform 
                      duration-300 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-[#C5364B]"
                  >
                    В корзину
                  </button>
                </div>
